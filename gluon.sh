...
bold='setterm -bold'
date="date"
KERNEL_BUILD="Splendiferous_Kernel_Jelleybean-`date '+%Y-%m-%d---%H-%M'`" 
echo $1 > VERSION	
VERSION='cat VERSION'
$yellow
...
echo " |~~~~~~~~~~~~~~~~~~~~~Darshana Chatterjee(My Lifemate)~~~~~~~~~~~~~~~~~~~| "
echo " |========================================================================| "
$violet
echo " |========================================================================| "
